/****************************************************************************
** Meta object code from reading C++ file 'syntactictreeviewer.h'
**
...
#error "The header file 'syntactictreeviewer.h' doesn't include <QObject>."
...
namespace {
struct qt_meta_tag_ZN19SyntacticTreeViewerE_t {};
} // unnamed namespace

template <> constexpr inline auto SyntacticTreeViewer::qt_create_metaobjectdata<qt_meta_tag_ZN19SyntacticTreeViewerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<SyntacticTreeViewer, qt_meta_tag_ZN19SyntacticTreeViewerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject SyntacticTreeViewer::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19SyntacticTreeViewerE_t>.metaTypes,
    nullptr
} };
...
void *SyntacticTreeViewer::qt_metacast(const char *_clname)
{
