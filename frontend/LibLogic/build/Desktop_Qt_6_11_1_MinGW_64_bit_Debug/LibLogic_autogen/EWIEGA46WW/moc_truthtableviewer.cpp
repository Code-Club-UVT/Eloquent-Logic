...
void TruthTableViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->requestMoreData(); break;
        case 1: _t->onScroll((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TruthTableViewer::*)()>(_a, &TruthTableViewer::requestMoreData, 0))
            return;
    }
}
...
// SIGNAL 0
void TruthTableViewer::requestMoreData()
{
