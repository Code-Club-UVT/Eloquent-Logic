...
namespace logic_agent::rpc
{
    ...
    void streaming_sat_listener::didBuildHeuristicsDatabase(const ClauseSet& clauses)
    {
    ...
    void streaming_sat_listener::didSatisfyClauseByUnitLiteral(const Clause& clause, Literal l)
    {
    ...
    void streaming_sat_listener::didReduceClauseByUnitLiteral(const Clause& original, const Clause& reduced, Literal l)
    {
    ...
    void streaming_sat_listener::didDeriveEmptyClauseFromUnitPropagation(Literal l)
    {
        logic_agent::types::sat::literal_event_t dto;
        dto.literal = l;
    ...
    void streaming_sat_listener::didEliminateClauseByPureLiteral(const Clause& clause, Literal l)
    {
        logic_agent::types::sat::clause_literal_event_t dto;
        dto.clause = logic_agent::types::sat::to_dto(clause);
        dto.literal = l;
    ...
    void streaming_sat_listener::didSelectResolutionCandidates(const Clause& first, const Clause& second)
    {
    ...
    void streaming_sat_listener::didComputeResolvent(const Clause& first, const Clause& second, Literal pivot, const Clause& resolvent)
    {
    ...
    void streaming_sat_listener::didDeriveEmptyClauseFromResolution() { sink.emit_empty("sat/didDeriveEmptyClauseFromResolution"); }
    ...
    void streaming_sat_listener::didReachResolutionSaturation() { sink.emit_empty("sat/didReachResolutionSaturation"); }
    ...
    void streaming_sat_listener::didChooseBranchingLiteral(Literal l, int frequency)
    {
    ...
    void streaming_sat_listener::didPopBranchContext() { sink.emit_empty("sat/didPopBranchContext"); }

    void streaming_sat_listener::didFindSatisfyingAssignment() { sink.emit_empty("sat/didFindSatisfyingAssignment"); }

    void streaming_sat_listener::didDetectConflict() { sink.emit_empty("sat/didDetectConflict"); }

    void streaming_sat_listener::didBacktrack() { sink.emit_empty("sat/didBacktrack"); }

    void streaming_sat_listener::didConcludeSat() { sink.emit_empty("sat/didConcludeSat"); }

    void streaming_sat_listener::didConcludeUnsat() { sink.emit_empty("sat/didConcludeUnsat"); }

    void streaming_sat_listener::didConcludeUnknown() { sink.emit_empty("sat/didConcludeUnknown"); }
}
