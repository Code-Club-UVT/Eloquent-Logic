...
void streaming_truth_table_listener::didStart() {
    sink.emit_empty("truth_table/didStart");
}

void streaming_truth_table_listener::didFinish() {
    sink.emit_empty("truth_table/didFinish");
}

void streaming_truth_table_listener::didFindUnknownVariable(
...
void streaming_truth_table_listener::didSetVariable(
...
void streaming_truth_table_listener::didComputeSubexpression(
    const CppCommon::UUID &node_id, bool value) {
