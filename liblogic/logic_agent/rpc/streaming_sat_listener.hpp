...
namespace logic_agent::rpc
{
    ...
    public:
        ...
        void didSatisfyClauseByUnitLiteral(const Clause& clause, Literal l) override;
        void didReduceClauseByUnitLiteral(const Clause& original, const Clause& reduced, Literal l) override;
        void didDeriveEmptyClauseFromUnitPropagation(Literal l) override;

        void didFindPureLiteral(Literal l) override;
        void didEliminateClauseByPureLiteral(const Clause& clause, Literal l) override;

        void didSelectResolutionCandidates(const Clause& first, const Clause& second) override;
        void didComputeResolvent(const Clause& first, const Clause& second, Literal pivot, const Clause& resolvent) override;
