...
class streaming_relaxed_parser_listener
    : public eloquent::logic::relaxed_parser_listener_t {
    event_sink &sink;
  ...
  public:
    ...
    void didFindPureAtomInParens(const eloquent::logic::lexeme &open,
                                 const eloquent::logic::lexeme &atom,
                                 const eloquent::logic::lexeme &close) override;
    ...
    void didJoin(const eloquent::logic::NodeObsPtr &target,
                 const eloquent::logic::NodeObsPtr &source) override;
    void
    didFindLowerPrecendenceOperator(const eloquent::logic::lexeme &l) override;
