...
{
    class streaming_truth_table_listener : public eloquent::logic::truth_table_listener_t
    {
        event_sink& sink;
    ...
    public:
        ...
        void didComputeSubexpression(const CppCommon::UUID& node_id, bool value) override;
    };
}
