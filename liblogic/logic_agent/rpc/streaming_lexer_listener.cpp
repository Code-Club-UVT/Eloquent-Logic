...
namespace logic_agent::rpc
{
    ...
    void streaming_lexer_listener::didFinish() { sink.emit_empty("lexer/didFinish"); }

    void streaming_lexer_listener::didRecogniseLexeme(const eloquent::logic::lexeme& l)
    {
    ...
    void streaming_lexer_listener::didFindUnrecognisedOperator(std::string_view text, size_t position)
    {
    ...
    void streaming_lexer_listener::didFindUnexpectedSequence(std::string_view sequence, size_t position)
    {
