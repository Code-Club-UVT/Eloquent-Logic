...
{
    class streaming_transformation_listener : public eloquent::logic::node_transformation_listener_t
    {
        event_sink& sink;
        ...
        void emit_single_node(std::string_view method, eloquent::logic::NodeObsPtr node) const;
