...
{
    class streaming_strict_parser_listener : public eloquent::logic::strict_parser_listener_t
    {
        event_sink& sink;
    ...
    public:
        ...
        void didTryInvalidPosition(eloquent::logic::NodeObsPtr node, size_t idx) override;
        void didTrySpawiningOverExistingNode(eloquent::logic::NodeObsPtr node) override;
        void spawnedNewChildNode(const eloquent::logic::NodeObsPtr& parent, const eloquent::logic::NodeObsPtr& child) override;
