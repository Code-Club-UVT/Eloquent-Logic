...
lexeme_type_t to_dto(eloquent::logic::lexeme_type t) {
    ...
    case lexeme_type::Atom:
        return lexeme_type_t::Atom;
    case lexeme_type::Tautology:
        return lexeme_type_t::Tautology;
    case lexeme_type::Contradiction:
        return lexeme_type_t::Contradiction;
    case lexeme_type::LParen:
        return lexeme_type_t::LParen;
    case lexeme_type::RParen:
        return lexeme_type_t::RParen;
    case lexeme_type::NotOp:
        return lexeme_type_t::NotOp;
    case lexeme_type::AndOp:
        return lexeme_type_t::AndOp;
    case lexeme_type::OrOp:
        return lexeme_type_t::OrOp;
    case lexeme_type::ImpliesOp:
        return lexeme_type_t::ImpliesOp;
    case lexeme_type::IffOp:
        return lexeme_type_t::IffOp;
    case lexeme_type::LEquiOp:
        return lexeme_type_t::LEquiOp;
    case lexeme_type::Eof:
        return lexeme_type_t::Eof;
    case lexeme_type::Unknown:
    default:
        return lexeme_type_t::Unknown;
    }
}
...
node_type_t to_dto(eloquent::logic::NodeType t) {
    ...
    switch (t) {
    case NodeType::Atom:
        return node_type_t::Atom;
    case NodeType::NotOp:
        return node_type_t::NotOp;
    case NodeType::AndOp:
        return node_type_t::AndOp;
    case NodeType::OrOp:
        return node_type_t::OrOp;
    case NodeType::ImpliesOp:
        return node_type_t::ImpliesOp;
    case NodeType::IffOp:
        return node_type_t::IffOp;
    case NodeType::LEquiOp:
        return node_type_t::LEquiOp;
    case NodeType::Blank:
    default:
        return node_type_t::Blank;
    }
}
} // namespace

uuid_t to_dto(const CppCommon::UUID &id) { return uuid_t{id.string()}; }
