...
//   - didFindUnknownVariable(string_view name)       ->
//   unknown_variable_event_t
//   - didSetVariable(string_view name, bool value)   ->
//   variable_assignment_event_t
//   - didComputeSubexpression(UUID node_id, bool value) ->
//   subexpression_result_event_t
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(subexpression_result_event_t, node_id,
                                   value);
} // namespace logic_agent::types::truth_table
