...
// DTOs for eloquent::logic::mapper_listener
// (src/sat/utilities/mapper_listener.hpp) callback parameters:
//   - did_map_literals(const std::map<std::string, Literal>&) ->
//   literal_mapping_event_t
//   - did_map_clauses(const ClauseSet&)                        ->
//   clause_set_event_t
