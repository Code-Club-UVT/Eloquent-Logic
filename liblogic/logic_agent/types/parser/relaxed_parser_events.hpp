...
//     didReadLexeme(lexeme)                          -> logic_agent::types::lexeme_t
//   - didFindPureAtomInParens(lexeme, lexeme, lexeme) -> pure_atom_in_parens_event_t
//   - didMakeNewSubtree(Node*)                        -> logic_agent::types::parser::single_node_event_t (cursor_events.hpp)
...
namespace logic_agent::types::parser
{
    ...
    struct pure_atom_in_parens_event_t
    {
        lexeme_t open_paren;
        lexeme_t atom;
    ...
    NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(pure_atom_in_parens_event_t, open_paren, atom, close_paren)
