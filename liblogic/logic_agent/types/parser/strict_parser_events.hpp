...
//   - didProcessLexeme(lexeme) / foundUnexpectedToken(lexeme)
//       -> logic_agent::types::parser::single_lexeme_event_t (lexer_events.hpp)
//   - didMakeNode(Node*) / didPlaceNodeAtCursor(Node*) /
//   wrongArityForNode(Node*)
//       -> logic_agent::types::parser::single_node_event_t (cursor_events.hpp)
//   - foundAstError(Cursor)                                   ->
//   ast_error_event_t
...
struct ast_error_event_t : public feedback_base {
    cursor_t cursor;
};
