...
// DTOs for eloquent::logic::cursor_listener_t
// (src/parser/cursor_listener_t.hpp) callback parameters that aren't already
// covered by a core type:
...
// didMakeNode/didPlaceNodeAtCursor/wrongArityForNode and
// relaxed_parser_listener_t's didMakeNewSubtree, which all carry exactly one
// Node*.
